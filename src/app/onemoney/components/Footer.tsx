        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <nav className="mt-6 space-y-4 text-sm">
              <Link href="/onemoney/#solutions" className="block text-foreground/80 hover:text-foreground transition">
                Our Solutions
              </Link>
            </nav>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <nav className="mt-6 space-y-4 text-sm">
              <Link href="/onemoney/compliance" className="block text-foreground/80 hover:text-foreground transition">
                Compliance
              </Link>
              <Link href="/onemoney/policies" className="block text-foreground/80 hover:text-foreground transition">
                Policies
              </Link>
            </nav>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <nav className="mt-6 space-y-4 text-sm">
              <Link href="/onemoney/vision-mission" className="block text-foreground/80 hover:text-foreground transition">
                Vision and Mission
              </Link>
              <Link href="/onemoney/leadership" className="block text-foreground/80 hover:text-foreground transition">
                Leadership
              </Link>
              <Link href="/onemoney/timeline" className="block text-foreground/80 hover:text-foreground transition">
