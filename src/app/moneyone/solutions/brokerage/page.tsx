        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mx-auto text-md text-slate-700 dark:text-slate-300 max-w-4xl md:text-lg">
              Choose from multiple integration modes and leverage powerful developer tools to implement MoneyOne's Brokerage platform in your workflow.
            </p>
          </div>
...
const integrationOptions = [
  {
    ...
    description: "Seamless integration with existing trading platforms and order management systems",
    icon: <Code className="w-6 h-6" />,
    image: "/API Integration.png",
  },
  {
    title: "Market Data Feeds",
    description: "Real-time market data and quote feeds from multiple exchanges",
    icon: <Webhook className="w-6 h-6" />,
    image: "/Webhook Support.png",
  },
  {
    title: "Client Portal",
    description: "White-label client portal for trading and portfolio management",
    icon: <Settings className="w-6 h-6" />,
    image: "/Hosted Page.png",
  },
  {
    title: "Mobile Trading App",
    description: "Native mobile applications for trading and portfolio tracking",
...
const developerFeatures = [
  {
    title: "Trading API",
    description: "Comprehensive API for order management and trading operations",
    icon: <Code className="w-6 h-6" />,
    image: "/API Integration.png",
  },
  {
    title: "Real-Time Data", 
    description: "Live market data and trade updates via WebSocket",
    icon: <Webhook className="w-6 h-6" />,
    image: "/Webhook Notification.png",
  },
  {
    title: "Order Management",
    description: "Advanced order routing and execution capabilities",
    icon: <Settings className="w-6 h-6" />,
              ...
              <div className="p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="mx-auto text-base text-slate-700 dark:text-slate-300 max-w-7xl">
                    From trading platform integration to mobile apps, choose the method that best fits your brokerage platform.
                  </p>
                </div>
              ...
              <div className="px-8 pt-8 pb-8">
                <div className="text-center mb-8">
                  ...
                  <p className="mx-auto text-base text-slate-700 dark:text-slate-300 max-w-5xl mb-8">
                    Built with developers in mind, MoneyOne provides comprehensive APIs, SDKs, and tools for seamless brokerage integration.
                  </p>
                </div>
