        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mx-auto text-md text-slate-700 dark:text-slate-300 max-w-4xl md:text-lg">
              Choose from multiple integration modes and leverage powerful developer tools to implement MoneyOne's Lending platform in your workflow.
            </p>
          </div>
...
const integrationOptions = [
  {
    ...
    description: "Seamless integration with existing core banking systems",
    icon: <Code className="w-6 h-6" />,
    image: "/API Integration.png",
  },
  {
    title: "Credit Bureau APIs",
    description: "Direct integration with credit bureaus for real-time data",
  ...
  {
    title: "Mobile Lending App",
    description: "Native mobile applications for loan processing",
...
const developerFeatures = [
  {
    title: "Lending API",
    description: "Comprehensive API for loan processing and management",
    icon: <Code className="w-6 h-6" />,
    image: "/API Integration.png",
  },
  {
    title: "Real-Time Notifications", 
    description: "Instant updates on loan status and payments",
    icon: <Webhook className="w-6 h-6" />,
    image: "/Webhook Notification.png",
  },
  {
    title: "Risk Engine",
    description: "Advanced risk modeling and scoring algorithms",
    icon: <Settings className="w-6 h-6" />,
    image: "/Field-level Config.png",
  },
  {
    title: "Reporting SDK",
    description: "Customizable reporting and analytics tools",
    icon: <Terminal className="w-6 h-6" />,
    image: "/JavaScript SDK.png",
  }
];
              ...
              <div className="p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="mx-auto text-base text-slate-700 dark:text-slate-300 max-w-7xl">
                    From core banking integration to mobile apps, choose the method that best fits your lending platform.
                  </p>
                </div>
              ...
              <div className="px-8 pt-8 pb-8">
                <div className="text-center mb-8">
                  ...
                  <p className="mx-auto text-base text-slate-700 dark:text-slate-300 max-w-5xl mb-8">
                    Built with developers in mind, MoneyOne provides comprehensive APIs, SDKs, and tools for seamless lending integration.
                  </p>
                </div>
