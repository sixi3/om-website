...
import { Clock, Building, FileText, Zap, MessageCircle, ShieldCheck, Link, CreditCard, Vote, Car, Share2, Scale, Globe, AlertTriangle, MapPin, Map, GraduationCap, Briefcase, Users, UserCheck, FileCheck, Settings, Code, Webhook, Terminal } from "lucide-react";
            ...
            <div className="max-w-3xl space-y-4">
              <span className="inline-flex items-center pl-1 pr-3 py-1 text-xs lg:text-md font-semibold text-slate-800 mb-6 md:mb-4 space-x-2 mx-auto lg:mx-0">
                <Image
                  ...
                  height={24}
                />
                <span>Fast, Flexible, and Compliant Gig Hiring</span>
              </span>
              ...
              <p className="font-medium text-lg sm:text-md text-slate-600 dark:text-slate-300 mb-8">
                Instantly verify, onboard, and manage gig workers at scale. Equal empowers you to hire flexibly, reduce risk, and stay compliant—no matter how fast your workforce grows.
              </p>
            </div>
            <div className="w-full flex flex-col items-center md:items-start mb-8">
              <span className="text-xs font-semibold tracking-widest text-slate-500 mb-2 uppercase">Trusted by leading gig platforms</span>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-xl items-center justify-items-center">
                {[
                  { name: "TeamLease", logo: "teamlease.png" },
                  { name: "NOBROKER", logo: "Nobroker.png" },
                  { name: "L&T", logo: "L&T.png" },
                  { name: "Wellness Forever", logo: "wellness.png" }
                ].map((client, idx) => (
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[525px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    See how Equal can help you scale your gig workforce with speed and compliance. Fill out the form below to schedule a demo with our team.
                  </DialogDescription>
                </DialogHeader>
                <div className="py-4">
                  <TalkToUsForm />
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl tracking-tight leading-tight sm:text-4xl md:text-5xl mb-4">
              ...
              <span className={metallicBlackTextClasses}>for Gig Hiring?</span>
            </h2>
            <p className="mx-auto text-lg text-slate-700 dark:text-slate-300 max-w-3xl">
              The fastest, most flexible, and most compliant way to hire and manage gig workers at scale.
            </p>
          </div>
          <div className="space-y-6">
            {/* First Row - 2 Cards */}
            <BentoGrid className="grid-cols-1 md:grid-cols-2 gap-4">
              {gigReasons.slice(0, 2).map((item, idx) => (
                <BentoGridItem
                  key={item.title}
                  className="shadow-sm"
                  title={
            ...
            <BentoGrid className="grid-cols-1 md:grid-cols-3 gap-4">
              {gigReasons.slice(2, 5).map((item, idx) => (
                <BentoGridItem
                  key={item.title}
                  className="shadow-sm"
                  title={
...
const gigReasons = [
  {
    ...
    description: "Verify and onboard gig workers in minutes, not days. Reduce time-to-hire and fill urgent roles fast.",
    image: {
  ...
  {
    title: "Scale Workforce Flexibly",
    description: "Easily ramp your workforce up or down to match demand spikes, events, or seasonal needs.",
    image: {
  ...
  },
  {
    ...
    description: "Stay compliant with labor laws and regulations for gig and contract workers, with built-in checks and audit trails.",
    image: {
      src: "/Compliance.png",
      alt: "Compliance"
    },
  ...
  },
  {
    ...
    description: "Engage gig workers via WhatsApp, SMS, and Email for higher response and completion rates.",
    image: {
  ...
  },
  {
    ...
    description: "Onboard and verify workers any time, anywhere, with a fully digital, mobile-first experience.",
    image: {
      src: "/Mobile UX.png",
      alt: "Mobile UX"
    },
