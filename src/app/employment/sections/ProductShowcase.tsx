...
const productsData = [
  {
    ...
    heroSubheadline: "Equal's BGV (IDG) is your digital front door for onboarding. Collect, verify, and confirm identity documents from any user in real-time — no coding, no chasing.",
    features: [
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {activeProduct.id === 'gateway' && (
                            <div className="absolute hidden md:block lg:scale-90 lg:bottom-[-170px] lg:right-[5px] xl:bottom-[-170px] xl:right-[15px] bottom-[-200px] right-[50px] scale-110 pointer-events-none">
