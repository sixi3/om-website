        ...
        <div className={cn("pt-8 px-2 h-20 text-white relative overflow-hidden", backgroundColor, "transition-all duration-700 ease-in-out")}>
            <div className="flex items-center justify-between relative z-10">
                ...
                <div className="flex-grow text-left ml-2">
                    <AnimatePresence mode="wait">
                        <motion.h1 key={title} variants={textVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3, ease: "easeInOut" }} className="text-[12px] font-bold">
                            {title}
                        </motion.h1>
                    </AnimatePresence>
                    <AnimatePresence mode="wait">
                        <motion.p key={subtitle} variants={textVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3, ease: "easeInOut" }} className="text-[10px] font-regular">
                            {subtitle}
                        </motion.p>
                    </AnimatePresence>
                </div>
